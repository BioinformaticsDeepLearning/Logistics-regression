...
#Note: In the output, user will find p value of the model. If Pvalue is more than 0.05, then we consider them to be insignificant in contributing to the value of the variable "am". Therefore, weight (wt) impacts the "am" value in this regression model.
